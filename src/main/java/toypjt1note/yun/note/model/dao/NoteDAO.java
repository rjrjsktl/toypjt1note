package toypjt1note.yun.note.model.dao;

import static toypjt1note.yun.note.JDBCTemplate.*;
...
public class NoteDAO {
	...
	public NoteDAO() {
		try {
			...
			String filePath = NoteDAO.class.getResource("/toypjt1note/yun/note/sql/Note-sql.xml").getPath();
